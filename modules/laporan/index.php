  ...
  <div class="col-md-6 col-lg-4">
    <div class="card h-100"><div class="card-body">
      ...
      <div class="d-flex gap-2 flex-wrap">
        ...
        <a class="btn btn-danger btn-sm" href="export_pdf.php?table=<?= e($t) ?>" target="_blank"><i class="fa-solid fa-file-pdf me-1"></i> PDF View</a>
        <a class="btn btn-primary btn-sm" href="export_pdf.php?table=<?= e($t) ?>&mode=download"><i class="fa-solid fa-download me-1"></i> PDF Download</a>
      </div>
    </div></div>
  </div>
<?php endforeach; ?>
